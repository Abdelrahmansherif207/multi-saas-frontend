...
interface CancelSettingsFormProps {
    translations: {
        main_title: string;
        subtitle: string;
...
export function CancelSettingsForm({ translations }: CancelSettingsFormProps) {
            ...
            <div className="bg-card/60 backdrop-blur-xl border border-border/40 rounded-2xl p-8 shadow-sm space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="space-y-2">
                    ...
                    <Input
                        ...
                        placeholder={activeTab === "en" ? "Order Cancelled" : "تم إلغاء الطلب"}
                    />
                </div>

                <div className="space-y-2">
                    <Label className="text-sm font-semibold text-foreground/80">
                        {translations.subtitle} ({activeTab === "en" ? "English" : "Arabic"})
                    </Label>
                    <Input
                        className="h-12 rounded-xl bg-background/50 border-border/40 focus:ring-brand-orange/20 focus:border-brand-orange"
                        placeholder={activeTab === "en" ? "Review your {pname} order" : "راجع طلب {pname} الخاص بك"}
                    />
                    <p className="text-xs text-muted-foreground italic pl-1">
                        {translations.subtitle_hint}
                    </p>
                </div>
                ...
                <div className="space-y-2">
                    ...
                    <Textarea
                        ...
                        placeholder={activeTab === "en" ? "We are sorry to see you cancel." : "نحن آسفون لإلغاء طلبك."}
                    />
                </div>
