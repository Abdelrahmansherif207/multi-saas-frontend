...
export default async function AllRequestsPage() {
    const t = await getTranslations("Admin.CustomDomain.AllRequests");
    ...
    return (
        <AdminPageWrapper
            ...
            breadcrumbs={[
                ...
                { label: tMenu("all_requests"), href: "/admin/custom-domain/all-requests" }
            ]}
        >
                    ...
                    <Table>
                        <TableHeader>
                            <TableRow className="bg-muted/50 hover:bg-muted/50 border-b-border/40">
                                ...
                                <TableHead className="font-semibold text-foreground">{t("table.old_domain")}</TableHead>
                                <TableHead className="font-semibold text-foreground">{t("table.new_domain")}</TableHead>
