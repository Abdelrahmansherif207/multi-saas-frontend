...
export default async function AllWalletPage() {
    const t = await getTranslations("Admin.WalletManage.AllWallet");
    ...
    return (
        <AdminPageWrapper
            ...
            breadcrumbs={[
                ...
                { label: tMenu("all_wallet"), href: "/admin/wallet" }
            ]}
        >
                    ...
                    <Table>
                        <TableHeader>
                            <TableRow className="bg-muted/50 hover:bg-muted/50 border-b-border/40">
                                ...
                                <TableHead className="font-semibold text-foreground">{t("table.wallet_balance")}</TableHead>
                                <TableHead className="font-semibold text-foreground">{t("table.status")}</TableHead>
                            </TableRow>
                        </TableHeader>
                        <TableBody>
                            <TableRow>
                                <TableCell colSpan={4} className="h-24 text-center text-muted-foreground bg-muted/5">
                                    {t("table.no_data")}
                                </TableCell>
                            </TableRow>
                        </TableBody>
